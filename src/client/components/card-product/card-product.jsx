...
export default class CardProductPage extends Component {
  ...
  render() {
    return (
      <div className="js-catalog-product _additionals catalog__item" data-id="314412">
        <div className="product js-product  " data-id="314412" data-url="https://www.perekrestok.ru/catalog/314412/quickView"
          id="ui-id-5">
          ...
          <div className="product__cost product-cost">
            <div className="price product-cost__current js-product__cost " data-cost="37.9" data-type="шт">
