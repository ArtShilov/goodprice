    ...
    return (
      <div className="header-container">
        <div className="xf-header__bar">
          ...
          <div claclassNamess="xf-header__search">
            <div className="js-header-search-block xf-full-header-search">
              <input className="xf-full-header-search__field tst_header-search js-search-input ui-autocomplete-input"
                type="search" name="search" placeholder="Поиск товаров (например: &quot;Мясо&quot;)" data-key="searchField"
                data-id="search" autocomplete="off" />
              <button className="xf-full-header-search__btn js-search-btn" type="submit" aria-label="Искать">
